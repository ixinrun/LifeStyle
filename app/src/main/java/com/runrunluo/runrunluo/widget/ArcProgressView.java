package com.runrunluo.runrunluo.widget;
...
import com.runrunluo.runrunluo.util.DensityUtil;
...
public class ArcProgressView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int width = measureSize(DensityUtil.dip2px(mContext,DEFAULT_WIDTH),widthMeasureSpec);
        int height = measureSize(DensityUtil.dip2px(mContext,DEFAULT_HEIGHT),heightMeasureSpec);
